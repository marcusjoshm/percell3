...
- [x] New experiments have percell_version "3.1.0"
- [x] open_database() detects old version and raises informative error

## Work Log

- 2026-02-17: Identified during plan review
- 2026-02-18: Implemented. Added `EXPECTED_VERSION = "3.1.0"` to schema.py, `SchemaVersionError` exception, version check in `open_database()` comparing major.minor. Tests added for old version, compatible patch version, and current version.
